...
workboxSW.router.registerRoute('https://pwagram-2a2b5.firebaseio.com/posts.json', function(args) {
...
workboxSW.precache([
  ...
  },
  {
    ...
    "revision": "9a733e18a0f2cc09686a164844f946d1"
  },
  {
    "url": "src/js/feed.min.js",
    "revision": "65039c2417edc518f73165ef3da0d6b7"
  },
  {
      ...
      readAllData('sync-posts')
        .then(function(data) {
          for (var dt of data) {
            ...
            fetch('https://us-central1-pwagram-2a2b5.cloudfunctions.net/storePostData', {
              method: 'POST',
              body: postData
            })
              .then(function(res) {
